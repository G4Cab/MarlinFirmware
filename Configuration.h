/** MLoewe CHOOSE YOUR SAPPHIRE PLUS CONFIG:
 * Variant1: X tmc2208, Y tmc2208, E a4988, single Z a4988, 1 endstop
 * Variant2: X tmc2208, Y tmx2208, E a4988, dual Z tmc2208, 2 endstops
 * Variant3: X tmc2208, Y tmx2208, E tmc2208, single Z tmc2208, 1 endstop
...
/**
 * MLoewe's Marlin build for TwoTrees Sapphire Plus with stock hardware
 * Every changed settings could be find by searching for MLoewe
 * 
...
#define STRING_CONFIG_H_AUTHOR "(MLoewe)" //MLoewe Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO //MLoewe
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Sapphire Plus MLoewe" //MLoewe
...
#define TEMP_SENSOR_BED 1 //MLoewe
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 12.71 //MLoewe
    #define DEFAULT_Ki 0.83  //MLoewe
    #define DEFAULT_Kd 48.40 //MLoewe
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 37.49  //MLoewe
  #define DEFAULT_bedKi 7.09   //MLoewe
  #define DEFAULT_bedKd 132.25 //MLoewe
...
#define EXTRUDE_MAXLENGTH 650 //MLoewe
...
#define X_MIN_ENDSTOP_INVERTING true //MLoewe Set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING false// Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING true //MLoewe Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING true //MLoewe Set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING true //MLoewe Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING true //MLoewe Set to true to invert the logic of the probe.
...
#if SapphirePlusVariant == 2 or SapphirePlusVariant == 5   //MLoewe
...
#define ENDSTOP_INTERRUPTS_FEATURE //MLoewe
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
  #define DEFAULT_AXIS_STEPS_PER_UNIT  { 80, 80, 1600, 411 }  //MLoewe
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2000, 2000, 800, 1000 } //MLoewe
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 1500 } //MLoewe
 ...
 */
#define S_CURVE_ACCELERATION //MLoewe
...
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR 1 //MLoewe
#define Z_HOME_DIR -1

// @section machine

// The size of the print bed
#define X_BED_SIZE 310 //MLoewe
#define Y_BED_SIZE 310 //MLoewe
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //MLoewe
...
#define LEVEL_BED_CORNERS //MLoewe
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (15*60) } //MLoewe
 ...
 */
#define EEPROM_SETTINGS     //MLoewe Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of PROGMEM. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
//#define EEPROM_BOOT_SILENT    //MLoewe Keep M503 quiet and only give errors during first load
...
#define PREHEAT_1_TEMP_HOTEND 190 //MLoewe
#define PREHEAT_1_TEMP_BED     55 //MLoewe
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" //MLoewe
#define PREHEAT_2_TEMP_HOTEND 215 //MLoewe
#define PREHEAT_2_TEMP_BED     70 //MLoewe
 ...
 */
#define NOZZLE_PARK_FEATURE     //MLoewe
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN //MLoewe
 ...
 */
#define SD_CHECK_AND_RETRY //MLoewe
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //MLoewe
 ...
 */
#define TFT_ROTATION TFT_NO_ROTATION //MLoewe
...
#define TOUCH_SCREEN //MLoewe
  ...
  //#define TOUCH_ORIENTATION TOUCH_LANDSCAPE
    ...
    #define SINGLE_TOUCH_NAVIGATION //MLoewe
  #endif
#endif
